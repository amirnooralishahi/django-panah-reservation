    ...
    <div class="room-card rounded-4 overflow-hidden border shadow-sm h-100">
      ...
      <div class="p-3">
        <div class="d-flex justify-content-between align-items-start gap-2 mb-2">
          ...
          <h5 class="mb-0 text-end fw-bold">
            {{ roomTitle }}
          </h5>
        ...
        <p class="text-end mb-3 small text-secondary">
          {{ roomDescription }}
        </p>
...
const roomImage = computed(() => {
  ...
  if (
    ...
    props.room.images[0]?.image
  ) {

    const img = props.room.images[0].image
...
const roomDescription = computed(() => {
  ...
  return (
    props.room?.Additional_details ||
    props.room?.building_Information ||
    "توضیحات ثبت نشده"
  )
