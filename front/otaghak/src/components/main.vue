        ...
        >
          ...
          >
            ...
            <span class="text-end">
              ...
              رفاهی منظره) تشکر ویژه دارم از جناب شعبانی
              عزیز بابت میزبانی عالیشون پیشنهاد میکنم
               تشکر از عوامل پناه
            </span>
          </swiper-slide>
          <swiper-slide
          ...
          >
            <span>امیر </span>
            <span class="text-end">
              به لحاظ موقعیت مکانی و دسترسی نزدیک است و منطقه خوب و امنی
          ...
          >
            <span>اکرم </span>
            <span class="text-end"
              >جای دلنشینی بود و پارکینگ و همه امکانات هم مثل
              همون چیزی که داخل سایت دیده بودیم بود کاملا و پک های بهداشتی که
              پناه داده بود بهمون هم خیلی مفید بود و اقاامت 
              مناسبی بود
            </span>
          </swiper-slide>
          <swiper-slide
          ...
          >
            ...
            <span class="text-end">
              سلام وقت بخیر. اقامتگاه بسیار عالی از همه لحاظ ( نظافت،امکانات
              رفاهی منظره) تشکر ویژه دارم از جناب عربی
              عزیز بابت میزبانی عالیشون پیشنهاد میکنم
      ...
      <div class="d-flex flex-column text">
        ...
        <div v-if="click" class="d-flex flex-column align-items-end gap-3">
          <span class="matn text-end"
            ...
            همراهی کنیم که پر از آرامش، اعتماد و امنیت باشد. از انتخاب مقصد گرفته
            تا لحظه‌های واپسین اقامت؛ پناه کنار شماست تا با خیال راحت، از هر لحظه
