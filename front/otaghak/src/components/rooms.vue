...
<div class="my-swiper-container mt-1">
    <swiper
      :modules="[Navigation]"
      :slides-per-view="4"
      :space-between="10"
    ...
    >       
            ...
            <swiper-slide v-for="(item,index) in imagearr" :key="index" class="slid ">
                <router-link to="/room" class="router">
                <div class="up position-relative">
                    <div class="icon position-absolute ms-1 text-white ">
                        <i class="bi bi-heart "></i>
                    </div>
                <img :src="item" alt="">
                </div>
                <div class="down d-flex flex-column gap-2 mt-2 ">
                    <h5 class="head text-end">اجاره سوییت مروارید با صبحانه رایگان تهران</h5>
                        <div class="detail d-flex justify-content-between">
                            ...
                            <div class="city">
                            <span>تهران</span>
                            <span class=''><i class="bi bi-dot"></i></span>
                            <span>تا 3 مهمان</span>
                            <span><i class="bi bi-dot"></i></span>
                            <span>بدون خواب </span>
                            </div>
                        </div> 
                        <div class="icon d-flex justify-content-end gap-1">
                            <span>
                        ...
                        <div class="price d-flex gap-2 justify-content-end">
                            <span>هر شب از </span>
                            <span>1/990/000</span>
                            <span>تومان</span>
                        </div>   
